...
Smoke-test skryptem `bun` importującym moduły wprost: progi gwiazdek/jakości, sumy tabel szans, dominacja słabego działania w ~2000 losowań selekcji, gwarancje wish/dream, `null` przy komplecie.
