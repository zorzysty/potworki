...
export const QUALITY_ORDER: readonly EggQuality[] = ["normal", "silver", "gold", "rainbow"]
...
export function qualityOdds(roundStars: number): readonly [number, number, number, number] {
