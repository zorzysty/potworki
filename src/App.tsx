...
export function App() {
	...
	return (
		...
		<div
			className={`${screen === "home" ? "app-home" : screen === "map" ? "app-map" : screen === "achievements" || screen === "collection" || screen === "village" || screen === "hatch" ? "app-catalog" : ""} min-h-dvh ${background} pt-[env(safe-area-inset-top)] pr-[env(safe-area-inset-right)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)]`}
		>
