...
describe("MONSTER_COUNT and MONSTERS", () => {
	test("MONSTER_COUNT === 72", () => {
		expect(MONSTER_COUNT).toBe(72)
	})

	test("MONSTERS.length === 72", () => {
...
describe("rarity distribution", () => {
	test("common: 36, rare: 21, epic: 11, legendary: 4", () => {
		...
		expect(IDS_BY_RARITY.legendary.length).toBe(4)
	})
})

describe("DNA uniqueness", () => {
	test("all 72 DNA signatures are unique", () => {
