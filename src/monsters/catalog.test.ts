...
describe("MONSTER_COUNT and MONSTERS", () => {
	test("MONSTER_COUNT === 88", () => {
		expect(MONSTER_COUNT).toBe(88)
	})

	test("MONSTERS.length === 88", () => {
		expect(MONSTERS.length).toBe(88)
	})
...
describe("rarity distribution", () => {
	test("common: 36, rare: 21, epic: 11, legendary: 20", () => {
		...
		expect(IDS_BY_RARITY.legendary.length).toBe(20)
	})
})

describe("DNA uniqueness", () => {
	test("all 88 DNA signatures are unique", () => {
