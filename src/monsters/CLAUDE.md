...
- Aktualnie `MONSTER_COUNT = 80`; id 72–75 to legendary **tylko-dzielenie**, 76–79 **tylko-luka**; pulę losowania per tryb daje `idsByRarityForMode` (blok ekskluzywny widoczny tylko dla swojego trybu).
...
- `bun test src/monsters` + galeria `?debug` (80 sztuk, identyczne po hard-refresh).
